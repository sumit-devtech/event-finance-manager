...
import { Users, Plus, X, CheckCircle } from './Icons';
...
export default function TeamAssignments({
  ...
  const availableMembers = organizationMembers.filter(
    member => !assignments.some(a => a.userId === member.userId)
  );
    ...
    <div className="space-y-6">
      ...
      {showAddForm && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h4 className="mb-4">Assign Team Member</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block text-gray-700 mb-2">Team Member</label>
              <select
      ...
      {assignments.length === 0 ? (
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-12 text-center">
          ...
          <h4 className="mb-2">No Team Members Assigned</h4>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gray-900">{assignment.user?.name || 'Unknown User'}</p>
              ...
              <div className="bg-blue-50 px-3 py-2 rounded-lg">
                ...
                <p className="text-blue-900">{assignment.role}</p>
              </div>
            </div>
          ))}
        </div>
